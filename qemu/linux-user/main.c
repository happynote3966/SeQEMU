...
static const struct qemu_argument arg_table[] = {
    ...
    {"seqemu-format-level","SEQEMU_FORMAT_LEVEL",true,handle_arg_format_level,
     "",           "configuration of format string security feature"},
    {"seqemu-buffer-level","SEQEMU_BUFFER_LEVEL",true,handle_arg_buffer_level,
     "",           "configuration of buffer overflow security feature"},
    {"seqemu-heap-level","SEQEMU_HEAP_LEVEL",true,handle_arg_heap_level,
     "",           "configuration of heap corruption security feature"},
    ...
    {"seqemu-relro-level","SEQEMU_RELRO_LEVEL",true,handle_arg_relro_level,
     "",           "configuration of RELRO security feature"},
    {"seqemu-disable-all","SEQEMU_DISABLE_ALL",false,handle_arg_disable_all,
     "",           "configure that all security feature is disable"},
    {"seqemu-abort-all","SEQEMU_ABORT_ALL",false,handle_arg_abort_all,
     "",           "configure that all security feature is abort"},
