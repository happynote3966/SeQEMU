...
typedef enum MigrationStatus {
    ...
    MIGRATION_STATUS_POSTCOPY_RECOVER = 7,
    MIGRATION_STATUS_COMPLETED = 8,
    MIGRATION_STATUS_FAILED = 9,
    MIGRATION_STATUS_COLO = 10,
    MIGRATION_STATUS_PRE_SWITCHOVER = 11,
    MIGRATION_STATUS_DEVICE = 12,
    MIGRATION_STATUS__MAX = 13,
} MigrationStatus;
...
typedef enum MigrationCapability {
    ...
    MIGRATION_CAPABILITY_LATE_BLOCK_ACTIVATE = 15,
    MIGRATION_CAPABILITY__MAX = 16,
} MigrationCapability;
...
typedef enum MigrationParameter {
    ...
    MIGRATION_PARAMETER_MAX_POSTCOPY_BANDWIDTH = 14,
    MIGRATION_PARAMETER__MAX = 15,
} MigrationParameter;
