...
void qmp_marshal_block_dirty_bitmap_add(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_block_dirty_bitmap_add(arg.node, arg.name, arg.has_granularity, arg.granularity, arg.has_persistent, arg.persistent, arg.has_autoload, arg.autoload, arg.has_x_disabled, arg.x_disabled, &err);
...
void qmp_marshal_x_block_dirty_bitmap_enable(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_x_block_dirty_bitmap_enable(arg.node, arg.name, &err);
...
void qmp_marshal_x_block_dirty_bitmap_disable(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_x_block_dirty_bitmap_disable(arg.node, arg.name, &err);
...
void qmp_marshal_x_block_dirty_bitmap_merge(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_x_block_dirty_bitmap_merge(arg.node, arg.dst_name, arg.src_name, &err);
