...
void visit_type_TransactionAction_members(Visitor *v, TransactionAction *obj, Error **errp)
{
    ...
    case TRANSACTION_ACTION_KIND_BLOCK_DIRTY_BITMAP_CLEAR:
        ...
        break;
    case TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_ENABLE:
        visit_type_q_obj_BlockDirtyBitmap_wrapper_members(v, &obj->u.x_block_dirty_bitmap_enable, &err);
        break;
    case TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_DISABLE:
        visit_type_q_obj_BlockDirtyBitmap_wrapper_members(v, &obj->u.x_block_dirty_bitmap_disable, &err);
        break;
