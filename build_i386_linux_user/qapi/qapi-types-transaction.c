...
const QEnumLookup TransactionActionKind_lookup = {
    .array = (const char *const[]) {
        ...
        [TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_ENABLE] = "x-block-dirty-bitmap-enable",
        [TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_DISABLE] = "x-block-dirty-bitmap-disable",
