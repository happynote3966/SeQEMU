...
void qmp_block_dirty_bitmap_add(const char *node, const char *name, bool has_granularity, uint32_t granularity, bool has_persistent, bool persistent, bool has_autoload, bool autoload, bool has_x_disabled, bool x_disabled, Error **errp);
...
void qmp_x_block_dirty_bitmap_enable(const char *node, const char *name, Error **errp);
void qmp_marshal_x_block_dirty_bitmap_enable(QDict *args, QObject **ret, Error **errp);
void qmp_x_block_dirty_bitmap_disable(const char *node, const char *name, Error **errp);
void qmp_marshal_x_block_dirty_bitmap_disable(QDict *args, QObject **ret, Error **errp);
void qmp_x_block_dirty_bitmap_merge(const char *node, const char *dst_name, const char *src_name, Error **errp);
void qmp_marshal_x_block_dirty_bitmap_merge(QDict *args, QObject **ret, Error **errp);
