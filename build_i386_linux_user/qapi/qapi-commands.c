...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "x-block-dirty-bitmap-enable",
                         qmp_marshal_x_block_dirty_bitmap_enable, QCO_NO_OPTIONS);
    qmp_register_command(cmds, "x-block-dirty-bitmap-disable",
                         qmp_marshal_x_block_dirty_bitmap_disable, QCO_NO_OPTIONS);
    qmp_register_command(cmds, "x-block-dirty-bitmap-merge",
                         qmp_marshal_x_block_dirty_bitmap_merge, QCO_NO_OPTIONS);
    ...
    qmp_register_command(cmds, "x-nbd-server-add-bitmap",
                         qmp_marshal_x_nbd_server_add_bitmap, QCO_NO_OPTIONS);
