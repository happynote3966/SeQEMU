...
typedef enum TransactionActionKind {
    ...
    TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_ENABLE = 3,
    TRANSACTION_ACTION_KIND_X_BLOCK_DIRTY_BITMAP_DISABLE = 4,
    TRANSACTION_ACTION_KIND_BLOCKDEV_BACKUP = 5,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT = 6,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT_INTERNAL_SYNC = 7,
    TRANSACTION_ACTION_KIND_BLOCKDEV_SNAPSHOT_SYNC = 8,
    TRANSACTION_ACTION_KIND_DRIVE_BACKUP = 9,
    TRANSACTION_ACTION_KIND__MAX = 10,
...
struct TransactionAction {
    ...
    union { /* union tag is @type */
        ...
        q_obj_BlockDirtyBitmap_wrapper x_block_dirty_bitmap_enable;
        q_obj_BlockDirtyBitmap_wrapper x_block_dirty_bitmap_disable;
